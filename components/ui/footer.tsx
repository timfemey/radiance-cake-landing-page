              ...
              <div className="mb-2">
                ...
                <Link href="/" className="inline-block">
                  <svg
                    ...
                    className="w-10 h-10 fill-current text-text"
                    fill="#000000"
                    viewBox="-4.64 0 122.88 122.88"
                    version="1.1"
                    id="Layer_1"
                  >
                    <g>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
              <li>
                <Link
                  href="/"
                  className="flex justify-center items-center text-text-600 bg-amber-800 hover:text-text-100 hover:bg-gray-600 rounded-full transition duration-150 ease-in-out"
                  aria-label="Twitter"
                >
                  <svg
